...
var style_Total_pessoas_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("População");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("População") !== null) {
        labelText = String(feature.get("População"));
    }
    if (value >= 0.000000 && value <= 232.285714) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 232.285714 && value <= 360.857143) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 360.857143 && value <= 471.428571) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 471.428571 && value <= 570.142857) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 570.142857 && value <= 651.428571) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 651.428571 && value <= 762.285714) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 762.285714 && value <= 1269.000000) {
            style = [ new ol.style.Style({
