...
var style_Total_domicilios_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Domicilios");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Domicilios") !== null) {
        labelText = String(feature.get("Domicilios"));
    }
    if (value >= 0.000000 && value <= 113.142857) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 180.285714 && value <= 214.714286) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 214.714286 && value <= 242.571429) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 242.571429 && value <= 282.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 282.000000 && value <= 320.857143) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 320.857143 && value <= 506.000000) {
            style = [ new ol.style.Style({
