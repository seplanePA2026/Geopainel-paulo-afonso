...
var style_Media_moradores_domicilios_parti_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Média de moradores em Domicílios Particulares Ocupados");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Média de moradores em Domicílios Particulares Ocupados") !== null) {
        labelText = String(feature.get("Média de moradores em Domicílios Particulares Ocupados"));
    }
    if (value >= 0.000000 && value <= 2.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.600000 && value <= 2.700000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.700000 && value <= 2.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.800000 && value <= 2.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.900000 && value <= 3.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.000000 && value <= 3.100000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.100000 && value <= 3.600000) {
            style = [ new ol.style.Style({
