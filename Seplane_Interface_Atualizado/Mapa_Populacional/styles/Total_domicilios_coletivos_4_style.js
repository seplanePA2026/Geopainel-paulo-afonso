...
var style_Total_domicilios_coletivos_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Domicilios Coletivos");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Domicilios Coletivos") !== null) {
        labelText = String(feature.get("Domicilios Coletivos"));
    }
