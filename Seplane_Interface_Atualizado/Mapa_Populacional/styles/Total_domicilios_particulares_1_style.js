...
var style_Total_domicilios_particulares_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Total de Domicílios Particulares Ocupados");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Total de Domicílios Particulares Ocupados") !== null) {
        labelText = String(feature.get("Total de Domicílios Particulares Ocupados"));
    }
    if (value >= 0.000000 && value <= 81.142857) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 81.142857 && value <= 129.285714) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 129.285714 && value <= 167.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 167.000000 && value <= 195.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 195.000000 && value <= 225.714286) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 225.714286 && value <= 263.285714) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 263.285714 && value <= 405.000000) {
            style = [ new ol.style.Style({
