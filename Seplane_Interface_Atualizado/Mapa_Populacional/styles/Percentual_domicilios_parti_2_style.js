...
var style_Percentual_domicilios_parti_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Percentual de Domicílios Particulares Ocupados Imputados");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Percentual de Domicílios Particulares Ocupados Imputados") !== null) {
        labelText = String(feature.get("Percentual de Domicílios Particulares Ocupados Imputados"));
    }
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000000 && value <= 0.005786) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.005786 && value <= 0.011171) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.011171 && value <= 0.017200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.017200 && value <= 0.026071) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.026071 && value <= 0.037271) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.037271 && value <= 0.132800) {
            style = [ new ol.style.Style({
